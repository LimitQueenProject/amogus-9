...
int cekPemenang(int _jenisPapan, char kotak[7][7])
{
    ...
    else if ( _jenisPapan == 5 )
    {
        ...
        else if (kotak[2][2] != ' ' && kotak[1][3] == kotak[2][2] && kotak[2][2] == kotak[3][1] && kotak[3][1] == kotak[4][0])
        {
            if (kotak[2][2] == 'X'){
                return 1;
            }
        ...
        else if (kotak[1][2] != ' ' && kotak[0][3] == kotak[1][2] && kotak[1][2] == kotak[2][1] && kotak[2][1] == kotak[3][0])
        {
            if (kotak[1][2] == 'X'){
                return 1;
            }
