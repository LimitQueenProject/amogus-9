...
struct Game
{
    ...
    int jenisPlayer; // untuk mengecek kondisi jenis player yang dimainkan

	int giliran; // untuk mengecek giliran yang menginput

	char papan[7][7]; // untuk papan matrik

	bool papan1; // untuk papan matrik 3x3 jika true
	bool papan2; // untuk papan matrik 3x3 jika true
	bool papan3; // untuk papan matrik 3x3 jika true
