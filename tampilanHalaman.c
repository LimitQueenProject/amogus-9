...
void inputNama( int _jenisPermainanPlayer, char (*_namaPlayer1)[20], char (*_namaPlayer2)[20])
{
    ...
    if ( _jenisPermainanPlayer == 1 )
    {
        do{
            ...
            // cek nama yang sama
            if( namaYangSama(*_namaPlayer1) == 0 && strlen(*_namaPlayer1) <= 20 ){
                valid = 1;
            }
            else{
    ...
    else if ( _jenisPermainanPlayer == 2 )
    {
        ...
        do{
            ...
            if ( strcmp(*_namaPlayer2 , *_namaPlayer1)==0)
            {
                koor(43,17); printf("Your name is the same as player 1's name, please re-enter");
                sleep(1);
            }
            else if (*_namaPlayer1 == *_namaPlayer2 && strlen(*_namaPlayer2) >= 20)
            {
                koor(43,17); printf("name cannot be the same as player 1 and name is too long, please re-enter");
                sleep(1);
            }
            
            else if (strlen(*_namaPlayer2) >= 20)
            {
                koor(43,17); printf("Your name is too long, please re-enter");
                sleep(1);
            }
            ...
            // cek nama yang sama
            if( namaYangSama(*_namaPlayer2) == 0 && strlen(*_namaPlayer2) <= 20 ){
                valid = 1;
            }
            else{
                koor(43,19); printf("The name is already exist!!                                  ");
